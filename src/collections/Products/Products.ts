...
export const Products: CollectionConfig = {
  ...
  //This lets us execute our own code when the product is created
  hooks: {
  ...
  fields: [
    ...
    },
    {
      ...
      hasMany: false,  //Change to true if multiple files (eg. Icon set with multiple file formats)
    },
    {
    ...
    {
      name: 'stripeId', //corresponds to product in stripe
      access: {
        create: () => false,
        read: () => false,
        update: () => false,
